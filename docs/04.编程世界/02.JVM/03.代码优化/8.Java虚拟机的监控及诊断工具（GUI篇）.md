...
![image-20220531145630552](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145630552-a3d2fc.png)
...
![image-20220531145638453](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145638453-df2eed.png)
...
![image-20220531145649922](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145649922-efceb2.png)
...
![image-20220531145656657](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145656657-6bac6e.png)
...
![image-20220531145703425](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145703425-0e4549.png)
...
![image-20220531145710066](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145710066-26c948.png)
...
![image-20220531145720771](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145720771-9d633b.png)

在 JMC GUI 客户端左侧的 JVM 浏览器中，我们可以看到所有正在运行的 Java 程序。当点击右键弹出菜单中的`Start Flight Recording...`时，JMC 便会弹出另一个窗口，用来配置 JFR 的启动参数，如下图所示：

![image-20220531145730020](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145730020-dc0405.png)
...
![image-20220531145740115](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145740115-28458e.png)

客户端的左边则罗列了 Java 虚拟机的各个子系统。JMC 将根据 JFR 所收集到的每个子系统的事件来进行可视化，转换成图或者表。

![image-20220531145754099](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145754099-db27fe.png)

这里我简单地介绍其中两个。

垃圾回收子系统所对应的选项卡展示了 JFR 所收集到的 GC 事件，以及基于这些 GC 事件的数据生成的堆已用空间的分布图，Metaspace 大小的分布图，最长暂停以及总暂停的直方分布图。

![image-20220531145802675](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145802675-05cc99.png)
...
![image-20220531145812739](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145812739-437c9f.png)
...
![image-20220531145820147](https://linkeq.oss-cn-chengdu.aliyuncs.com/img/2022/05/31/image-20220531145820147-f61f2c.png)
